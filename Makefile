...
flex: 
	...
	# go get -u github.com/researchapps/flux-sched/resource/reapi/bindings/go/src/fluxcli@0f33b17f6e792c14a262609d71f4ea5f32cb3ebb
	go mod tidy
	mkdir -p ./bin
	$(COMMONENVVAR) $(BUILDENVVAR) go build -ldflags '-w' -o bin/archspec src/cmd/main.go
